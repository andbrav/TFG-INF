...
sample = np.random.choice(X_train.shape[0], size=30000, replace=False)
...
print(y_small)
print(y_small.shape)
np.savez_compressed('mnist_medium.npz',X=X_small,y=y_small, index=sample)

mnist= np.load('mnist_medium.npz')
print(mnist)
X_small=mnist['X']
y_small=mnist['y']
