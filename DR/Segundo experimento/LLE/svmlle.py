...
#Parameters
dr= [(1,6),(2,5),(3,6),(4,5),(5,6),(6,4),(7,6),(8,4),(9,6),(10,9),(50,9),(100,9),(200,7)]
...
with open("svmlle.csv","w", newline='') as file:
...
for d in dr:
    ...
    drmodel = pickle.load(open('lle%s_%s_dense.pckl' % (str(dim),str(vecinos)),"rb"))
