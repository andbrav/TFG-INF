...
#Parameters
dr= [(1,9),(2,4),(3,3),(4,8),(5,8)(6,9),(7,9),(8,9),(9,9),(10,9),(50,9),(100,9),(200,9)]
...
with open("svmiso.csv","w", newline='') as file:
...
for d in dr:
    ...
    drmodel = pickle.load(open('iso%s_%s_dense.pckl' % (str(dim),str(vecinos)),"rb"))
